...
Manual package downloads remain available from the [0.9.0 release][release].
...
[release]: https://github.com/48hoursnonstop/proton-vpn-omarchy-core/releases/tag/v0.9.0
