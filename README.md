...
Manual package downloads remain available from the [0.8.3 release][release].
...
[release]: https://github.com/48hoursnonstop/proton-vpn-omarchy-core/releases/tag/v0.8.3
